...
class OptionsStep extends Component {
  ...
  renderOption(option) {
    const { optionStyle, optionElementStyle, fontFamily, fontSize, boldFontFamily } = this.props;
      ...
      >
        ...
        >
          <OptionText
            ...
            fontSize={fontSize}
            baseFontStyle={{ color: fontColor, fontFamily, fontSize }}
            html={label}
            tagsStyles={{ bold: { color: fontColor, fontFamily: boldFontFamily, fontSize } }}
          />
        </OptionElement>
      </Option>
    );
